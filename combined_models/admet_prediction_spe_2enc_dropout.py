...
results_onelayer_256_2enc_bert = admet_performance(seed_options = [1, 2, 3, 4, 5], 
                                                     ...
                                                     hidden_layer = 256, lID = 1, sID = sID, dropout_admet = 0.4,
...
with open("/home/ubuntu/Bertsmiles_git/TDC_ADMET/results_paper/c2enc_bert_onelayer_256_dropout.json", "w") as json_file:
...
results_onelayer_768_2enc_bert = admet_performance(seed_options = [1, 2, 3, 4, 5], 
                                                     ...
                                                     group = group, group_config = benchmark_config, 
                                                     model_dir = "/vol/bertdata/smiletobert_admet/best_models/", 
                                                     hidden_layer = 768, lID = 1, sID = sID, dropout_admet = 0.4,
                                                     blocks_freeze_b = ['bert.encoder_blocks.3'], spe = spe)
...
with open("/home/ubuntu/Bertsmiles_git/TDC_ADMET/results_paper/c2enc_bert_onelayer_768_dropout.json", "w") as json_file:
...
with open("/home/ubuntu/Bertsmiles_git/TDC_ADMET/results_paper/c2enc_bert_twolayer_256_dropout.json", "w") as json_file:
...
with open("/home/ubuntu/Bertsmiles_git/TDC_ADMET/results_paper/c2enc_bert_twolayer_768_dropout.json", "w") as json_file:
